...
def generate_prerelease_artifacts(pipeline,
                                  aws_access_key_id,
                                  aws_secret_access_key,
                                  play,
                                  deployment,
    ...
    """
    Pattern to generate pre-release artifacts. Generates the following artifacts:
    ...
    jobs.generate_base_ami_selection(
        pipeline,
        stage,
        aws_access_key_id,
        aws_secret_access_key,
        ...
        edx_environment,
        base_ami_id,
        base_ami_id_override,
    )
    jobs.generate_versions_manifest(stage)
    return stage
